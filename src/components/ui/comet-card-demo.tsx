...
export default function CometCardDemo() {
  return (
    <CometCard>
      <button
        type="button"
        className="my-10 flex w-80 cursor-pointer flex-col items-stretch rounded-[16px] border-0 bg-card p-2 saturate-0 md:my-20 md:p-4"
      ...
      >
        ...
        <div className="mt-2 flex flex-shrink-0 items-center justify-between p-4 font-mono text-foreground">
          ...
          <div className="text-xs text-muted-foreground opacity-50">#F7RA</div>
        </div>
      </button>
    </CometCard>
  );
