...
-- Mudar recomendante para aceitar múltiplos valores (usando conversão adequada)
ALTER TABLE leads ALTER COLUMN recomendante TYPE text[] USING 
  CASE 
    WHEN recomendante IS NULL OR recomendante = '' THEN NULL
    ELSE ARRAY[recomendante]
  END;
